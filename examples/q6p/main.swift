...
graph.openStore(
  "/home/liu/workspace/swift-diffusion/realistic_vision_v3_0_f16.ckpt", flags: .truncateWhenClose
) { store in
  let keys = store.keys
  graph.openStore(
    "/home/liu/workspace/swift-diffusion/realistic_vision_v3.0_q6p_q8p.ckpt",
