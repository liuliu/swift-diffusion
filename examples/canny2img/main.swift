...
var u8Img = ccv_dense_matrix_new(Int32(startHeight * 8), Int32(startWidth * 8), Int32(CCV_8U | CCV_C1), nil, 0)!
if let image = try PNG.Data.Rectangular.decompress(path: workDir + "/init_img.png") {
  ...
  for y in 0..<startHeight * 8 {
    for x in 0..<startWidth * 8 {
      ...
      u8Img.pointee.data.u8[y * startWidth * 8 + x] = UInt8((Int32(pixel.r) * 6969 + Int32(pixel.g) * 23434 + Int32(pixel.b) * 2365) >> 15)
